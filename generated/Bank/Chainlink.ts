...
export class Chainlink extends ethereum.SmartContract {
  ...
  getRoundData(_roundId: BigInt): Chainlink__getRoundDataResult {
    let result = super.call(
      "getRoundData",
  ...
  latestRoundData(): Chainlink__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
  ...
  try_latestRoundData(): ethereum.CallResult<Chainlink__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
      []
  ...
  proposedLatestRoundData(): Chainlink__proposedLatestRoundDataResult {
    let result = super.call(
